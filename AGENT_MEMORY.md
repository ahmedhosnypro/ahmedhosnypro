# Developer Memory & Profile Context

## Core Identity & Positioning
- **Name:** Ahmed Hosny
- **GitHub:** [@ahmedhosnypro](https://github.com/ahmedhosnypro)
...
- **Agentic AI & Daily Tooling:**
  ...
  - **Frameworks & Protocols:** Model Context Protocol (MCP) server & client development, local LLM acceleration with Intel OpenVINO (NPU/iGPU).
- **Databases & ORMs:** PostgreSQL, Microsoft SQL Server, Drizzle ORM, Prisma (v7/v8), Entity Framework Core, Spring Data JPA.
- **Frontend & UI:** React 19, Next.js 15/16, Material UI (MUI), Tailwind CSS 4, shadcn/ui, Recharts, Zustand, next-intl.
...
- **Contribution Snake:** `.github/workflows/snake.yml` runs daily and on push, rendering an animated contribution snake to the `output` branch.

## Agent Directives for README Maintenance
- **Tone:** Professional, direct, technically rigorous, zero fluff.
- **Style Rules:** Dark mode optimized (`github_dark` or `tokyonight`), SVG badges with consistent flat-square style, no noisy animations or rainbow counters.
- **Links & Dynamic Data:** Maintain valid project links, live deployments, and working stats mirrors.
